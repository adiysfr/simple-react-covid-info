        ...
        axios
            ...
            .then(res => {
                ...
                const recovered = ( <
                    ...
                    p className = 'count-content' > { ' ' } { helper.checkFormat(data.recovered) } <
                    /p> <
                    /div>
                );
        ...
        axios
            ...
            .then(res => {
                ...
                const casesNowIndonesia = ( <
                    ...
                    p className = 'count-content' > { ' ' } { helper.checkFormat(data.todayCases) } <
                    /p> <
                    /div>
                );
                const deathsNowIndonesia = ( <
                    ...
                    p className = 'count-content' > { ' ' } { helper.checkFormat(data.todayDeaths) } <
                    /p> <
                    /div>
                );
        ...
        return ( <
            > {
                this.state.isLoading ? ( <
                    ...
                    <
                    /center> <
                    div className = 'ctr' > { this.state.positiveIndonesia } <
                    /div> <
                    /div> <
                    /Col> <
                    Col xs = '4' >
                    ...
                    <
                    /center> <
                    div className = 'ctr' > { this.state.recoveredIndonesia } <
                    /div> <
                    /div> <
                    /Col> <
                    Col xs = '4' >
                    ...
                    <
                    /center> <
                    div className = 'ctr' > { this.state.deathsIndonesia } <
                    /div> <
                    /div> <
                    /Col> <
                    Col xs = '4' >
                    ...
                    <
                    /center> <
                    div className = 'ctr' > { this.state.casesNowIndonesia } <
                    /div> <
                    /div> <
                    /Col> <
                    Col xs = '4' >
                    ...
                    <
                    /center> <
                    div className = 'ctr' > { this.state.deathsNowIndonesia } <
                    /div> <
                    /div> <
                    /Col> <
                    /Row> <
